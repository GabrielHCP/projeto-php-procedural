<?php 
// Define um título padrão caso a variável não seja definida pelo controlador (safety check)
$titulo_pagina = $titulo_pagina ?? "Sistema Interno | Dashboard";
?>
...
<body>
	<div class="wrapper">
				...
				<ul class="sidebar-nav">
					...
					<li class="sidebar-item">
						<a class="sidebar-link" href="ui-buttons.html">
                            <i class="align-middle" data-feather="user-check"></i> <span class="align-middle">Meu cadastro</span>
                        </a>
					</li>
		...
		<div class="main">
					...
					<ul class="navbar-nav navbar-align">
						...
						<li class="nav-item dropdown">
							...
							<a class="nav-link dropdown-toggle d-none d-sm-inline-block" href="#" data-bs-toggle="dropdown">
                                <img src="/assets/img/avatars/avatar.jpg" class="avatar img-fluid rounded me-1" alt="User Photo" /> <span class="text-dark"><?= htmlspecialchars(ucfirst($_SESSION['user_nome'])); ?></span>
                            </a>
            ...
            <!-- O MAIN FICA ABERTO PARA SER FECHADO PELO FOOTER -->
			<main class="content">